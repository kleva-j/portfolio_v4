export const metadata = {
  title: "Binary Search",
  description: "A brief overview on binary search.",
  summary:
    "A brief overview on binary search. I wanted to better understand how binary search works.",
  alternates: {
    canonical: "/post/binary-search",
  },
